    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-[90vw] max-w-2xl p-6 z-10 overflow-y-auto max-h-[90vh]">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4 border-t pt-4">
          ...
          <p>
            <strong>Absent:</strong> {selectedEmp?.salaryDetails?.absent || 0}
          </p>
          <div className="mb-2">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4 border-t pt-4">
          <p>
            ...
            {selectedEmp?.salaryDetails?.attendanceStats?.earlyDepartureCount ||
              0}
          </p>
          <p>
          ...
          <p>
            ...
            {selectedEmp?.salaryDetails?.attendanceStats?.totalLatenessHours ||
              0}
          </p>
        </div>
        {/* Close button */}
